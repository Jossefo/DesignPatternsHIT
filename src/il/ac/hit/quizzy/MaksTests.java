...
public class MaksTests {
    ...
    public static void main(String argos[]) {
        ...
        builder1.addAnswer("starts with the letter ‘B’.",false);
        builder1.addAnswer("starts with the letter ‘C’.",true);
        builder1.addAnswer("starts with the letter ‘D’.",false);
        builder1.addAnswer("starts with the letter ‘E’.",false);
        ...
        IQuizQuestion question2 = builder.create();
